...
function makeCounter() {
    ...
    counter1(); // 2
    counter1();
    // a) counter1 and counter2 DO remain independent
    counter2();
    counter1();
    counter2();
    counter1();
...
// b) Trying to figure out how to define "startFrom" (ReferenceError: startFrom is not defined)
/* my workfunction makeCounter(counter1, counter2) {
    let currentCount = 0;
    return function() {
    currentCount++;
    ...
    function makeCounterB(startFrom) { 
        ...
        //tests print #4, #3, #2, #1 because delayMsg doesn't use setTimeout and runs first,  then the others according to their delays 
